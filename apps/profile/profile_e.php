...
if (empty($_FILES['img']['name'])) {
    ...
    if(empty($_POST['newpassword'])) {
      ...
      if ($con->query($sql) === TRUE) {
          Redir('index.php?mod=profile&act=t');
      } else {
    ...
    //avatar update
        ...
        ?>
                        <div class="form-group">
                            <label class="col-sm-12 control-label">NIM</label>
                            <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label class="col-sm-12 control-label">Kerja</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="work" value="<?php echo $row['work'] ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-12 control-label">Bio</label>
                            <div class="col-sm-12">
                        ...
                        <div class="form-group">
                                                        <div class="col-sm-12">
                                <select class="form-control" name="level" hidden>
        <?php
            ...
            ?>
                ...
                echo ' selected=selected';
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input class="bootstrap-switch" type="checkbox" data-on-color="success" data-size="small" name="status" <?php if ($row['status'] == 1) { echo 'checked="checked"';} ?>>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-12 control-label"></label>
                            <div class="col-sm-12">
                                <button id="sub" class="btn btn-success btn-round" type="submit">Simpan</button>
                            </div>
                        </div>
                      </div>
                </div>
