        ...
        <div class="page-header page-header-small" filter-color="blue">
            ...
            <div class="container">
                <div class="content-center">
                    ...
                    <p class="category"><?php echo $row['work']; ?></p>
                    <div class="content">
        ...
        <div class="section">
            <div class="container">
                <div class="button-container">
                    ...
                    <a href="index.php?mod=profile&act=e&id=<?php echo $id ?>" class="btn btn-warning btn-round btn-lg btn-icon" rel="tooltip" title="Ubah Profile">
                        <i class="fa fa-gear"></i>
                    </a>
                </div>
                <h3 class="title">Tentang</h3>
                <p class="description">Orang biasa memanggil saya <?php echo $row['nama']; ?>, bidang keahlian saya adalah koding dan juga sedikit pada jaringan. Untuk progam sendiri, saya lebih mahir untuk website. Asal saya dari <?php echo $row['tempat_lahir']; ?>. Untuk sekarang saya sedang menempuh pendidikan sarjana di Universitas AMIKOM Yogyakarta. Alamat saya adalah <?php echo $row['alamat']; ?>. Saya lahir di <?php echo $row['tempat_lahir']; ?>, <?php echo $row['ttl']; ?>. Nomor Telepon saya adalah <?php echo $row['no_hp']; ?> Bisa menghubungi saya dengan email <?php echo $row['email']; ?> Status saya adalah Mahasiswa dengan Jurusan Teknik Informatika
                </p>
                <div class="row">
