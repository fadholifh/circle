...
<?php
$q = $_POST['q'];
  $sql    =   "SELECT a.*, b.tipe, c.nama as forum FROM post a INNER JOIN lowker b ON a.lowker_id = b.lowker_id INNER JOIN forum c ON a.forum_id = c.forum_id WHERE a.status=1 AND a.judul LIKE '%$q%' OR a.isi LIKE '%$q%' ORDER BY a.waktu DESC";
