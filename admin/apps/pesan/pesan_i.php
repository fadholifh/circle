...
if (!isset($_SESSION['login'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $sql = "INSERT INTO pesan (pengirim_id, penerima_id, isi, waktu, status)
        VALUES ('$pengirim_id', '$penerima_id', '$isi', '$waktu','$status')";
    ...
    if (1 == 0) {
        ...
        <div class="cl-mcont">
            ...
            <div class="block-flat">
                <div class="header">
                    <h3><i class="fa fa-file-o nav-icon"></i> Tambah pesan</h3>
                </div>
                <div class="content">
        ...
        <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control datetime" name="waktu">
                            </div>
                        </div>
                        <div class="form-group">
