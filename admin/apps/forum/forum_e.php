...
if (!isset($_SESSION['login'])) {
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      $sql = "UPDATE forum SET nama='$nama', status='$status' WHERE forum_id=$id";
    ...
    if (1 == 0) {
        ...
        <div class="cl-mcont">
            ...
            <div class="block-flat">
                <div class="header">
                    <h3><i class="fa fa-tags nav-icon"></i> Edit Forum</h3>
                </div>
                <div class="content">
                    <form class="form-horizontal group-border-dashed" style="border-radius: 0px;" role="form" method="post" action="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="hidden" name="forum_id" class="form-control" value="<?php echo $row['forum_id']; ?>">
